    ...
    <div className="min-h-screen text-foreground" style={{ scrollBehavior: "smooth", backgroundColor: theme === "dark" ? undefined : "#FFFBF7" }}>
      ...
      <section className="py-10 overflow-hidden">
        <div className="flex animate-marquee" style={{ width: "max-content" }}>
          {[
            { src: "/images/wedding/selfie-01.jpg", alt: "Bride with bridesmaids golden hour" },
            { src: "/images/wedding/selfie-02.jpg", alt: "Groom with groomsmen ceremony arch" },
            { src: "/images/wedding/selfie-03.jpg", alt: "Couple selfie fairy lights" },
            { src: "/images/wedding/selfie-04.jpg", alt: "Diverse group on dance floor" },
            { src: "/images/wedding/selfie-05.jpg", alt: "Elderly couple at reception" },
            { src: "/images/wedding/selfie-06.jpg", alt: "Group at floral wall backdrop" },
            { src: "/images/wedding/selfie-07.jpg", alt: "Kids flower girl and ring bearers" },
            { src: "/images/wedding/selfie-08.jpg", alt: "Mother and bride emotional moment" },
            { src: "/images/wedding/selfie-09.jpg", alt: "Champagne toast vineyard sunset" },
            { src: "/images/wedding/selfie-10.jpg", alt: "Sparkler exit group selfie" },
            { src: "/images/wedding/selfie-11.jpg", alt: "Bride with friends ceremony arch" },
            { src: "/images/wedding/selfie-12.jpg", alt: "Big group selfie outdoor reception" },
